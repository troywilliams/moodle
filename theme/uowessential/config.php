...
$THEME->name = 'uowessential';

// The only thing you need to change in this file when copying it to
// create a new theme is the name above. You also need to change the name
// in version.php and lang/en/theme_uowessential.php as well.
...
$THEME->layouts = array(
    ...
    'standard' => array(
        'file' => 'general.php',
        'regions' => array('side-pre', 'side-post', 'hidden-dock'),
        'defaultregion' => 'side-post',
    ),
    // Course page.
    'course' => array(
...
$THEME->csspostprocess = 'theme_uowessential_process_css';
