 ...
 *
 *
 * @package   theme_uowessential based on essential
...
<head>
    ...
    <noscript>
			<link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot;?>/theme/uowessential/style/nojs.css" />
	</noscript>
</head>
...
?>
    ...
    <?php if ($hasslide1) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide1url) { ?>
                <a href="<?php echo $slide1url ?>" class="da-link"><?php echo get_string('readmore','theme_uowessential')?></a>
            <?php } ?>
    ...
    <?php if ($hasslide2) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide2url) { ?>
                <a href="<?php echo $slide2url ?>" class="da-link"><?php echo get_string('readmore','theme_uowessential')?></a>
            <?php } ?>
    ...
    <?php if ($hasslide3) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide3url) { ?>
                <a href="<?php echo $slide3url ?>" class="da-link"><?php echo get_string('readmore','theme_uowessential')?></a>
            <?php } ?>
    ...
    <?php if ($hasslide4) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide4url) { ?>
                <a href="<?php echo $slide4url ?>" class="da-link"><?php echo get_string('readmore','theme_uowessential')?></a>
            <?php } ?>
...
<div id="page-content" class="row-fluid">
	<div id="<?php echo $regionbsid ?>" class="span12">
		<div class="row-fluid">
			<?php echo $OUTPUT->uowessentialblocks('side-pre', 'span3 pull-left'); ?>
			<div id="region-main-uowessential" class="span9">
...
<div class="hidden-blocks">
    <div class="row-fluid">
        <h4><?php echo get_string('visibleadminonly', 'theme_uowessential') ?></h4>
            <?php
                echo $OUTPUT->uowessentialblocks('hidden-dock');
            ?>
    </div>
</div>
<?php } ?>
