...
if (strpos($checkuseragent, 'MSIE 7')) {
	echo get_string('ie7message', 'theme_uowessential');
}?>
...
<?php
    ...
    <div class="row-fluid">
            <div id="headerlogo" class="span3"><img src="<?php echo $CFG->wwwroot.'/theme/uowessential/pix/logo.jpg' ?>" alt="The University of Waikato crest" /> </div>
        <div id="title" class="span4"> 
            <h1><?php echo shorten_text($PAGE->heading, 50); ?></h1>
        </div>
        ...
        <p id="socialheading"><?php echo get_string('socialnetworks','theme_uowessential')?></p>
            <ul class="socials unstyled">
                <?php if ($haswebsite) { ?>
        ...
        <p id="socialheading"><?php echo get_string('mobileappsheading','theme_uowessential')?></p>
            <ul class="socials unstyled">
                <?php if ($hasios) { ?>
