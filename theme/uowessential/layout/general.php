 ...
 *
 * @package    theme
 * @subpackage uowessential based on essential
...
if ($rtl) {
    ...
    // In RTL the sides are reversed, so swap the 'uowessentialblocks' method parameter....
    $temp = $pre;
    $pre = $post;
    $post = $temp;
} else {
        ...
        <div id="<?php echo $regionbsid ?>" class="<?php echo $regionclass; ?>">
            <div class="row-fluid">
                <?php if ($hasboringlayout) { ?>
                	<div id="region-main-uowessential" class="<?php echo $contentclass; ?> pull-right">
                <?php } else { ?>
                	<div id="region-main-uowessential" class="<?php echo $contentclass; ?>">
                <?php } ?>
                ...
                <?php 
                if ($hasboringlayout) {
					echo $OUTPUT->uowessentialblocks($pre, $blockclass.' desktop-first-column'); 
				} else {
					echo $OUTPUT->uowessentialblocks($pre, $blockclass.' pull-right');
				}
				?>
            </div>
        </div>
        <?php echo $OUTPUT->uowessentialblocks($post, 'span3'); ?>
    </div>
</div>
</div>
<!-- End Main Regions --> 
<a href="#top" class="back-to-top"><i class="icon-chevron-sign-up"></i><p><?php print_string('backtotop', 'theme_uowessential'); ?></p></a>
