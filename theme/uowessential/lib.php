...
function theme_uowessential_set_fontwww($css) {
    global $CFG, $PAGE;
 ...
 */
function theme_uowessential_set_logo($css, $logo) {
    global $OUTPUT;
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 * @return bool
 */
function theme_uowessential_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
 ...
 * @return string
 */
function uowessential_set_editicons($css, $editicons) {
	global $CFG;
	if (!empty($CFG->themedir)) {
		$editiconsurl = $CFG->themedir . '/uowessential/style/editicons.css'; //Pull the full path for autohide css
	} else {
		$editiconsurl = $CFG->dirroot . '/theme/uowessential/style/editicons.css'; //MDL-36065
	}
 ...
 */
function uowessential_set_autohide($css, $autohide) {
	global $CFG;
	if (!empty($CFG->themedir)) {
		$autohideurl = $CFG->themedir . '/uowessential/style/autohide.css'; //Pull the full path for autohide css
	} else {
		$autohideurl = $CFG->dirroot . '/theme/uowessential/style/autohide.css'; //MDL-36065
	}
 ...
 * @return string
 */
function uowessential_performance_output($param) {
 ...
 */
function uowessential_set_customcss($css, $customcss) {
...
function theme_uowessential_process_css($css, $theme) {
    ...
    $css = theme_uowessential_set_themecolor($css, $themecolor);
    ...
    $css = theme_uowessential_set_themehovercolor($css, $themehovercolor);
    ...
    $css = theme_uowessential_set_footercolor($css, $footercolor);
    ...
    $css = theme_uowessential_set_footersepcolor($css, $footersepcolor);
    ...
    $css = theme_uowessential_set_footertextcolor($css, $footertextcolor);
    ...
    $css = theme_uowessential_set_footerurlcolor($css, $footerurlcolor);
    ...
    $css = theme_uowessential_set_footerhovercolor($css, $footerhovercolor);
...
// Set the footer heading color.
    ...
    $css = theme_uowessential_set_footerheadingcolor($css, $footerheadingcolor);
    ...
    $css = theme_uowessential_set_navbarsep($css, $navbarsep);
    ...
    $css = uowessential_set_editicons($css, $editicons);
    ...
    $css = uowessential_set_autohide($css, $autohide);
    ...
    $css = uowessential_set_customcss($css, $customcss);

    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_uowessential_set_logo($css, $logo);
    
    // Set the background image for the page.
    $setting = 'pagebackground';
    $pagebackground = $theme->setting_file_url($setting, $setting);
    $css = theme_uowessential_set_pagebackground($css, $pagebackground, $setting);
    ...
    $css = theme_uowessential_set_slideimage($css, $slideimage, $setting);
    ...
    $css = theme_uowessential_set_marketingheight($css, $marketingheight);
    ...
    $css = theme_uowessential_set_marketingimage($css, $marketingimage, $setting);
    ...
    // Set the font path.
    $css = theme_uowessential_set_fontwww($css);
    return $css;
}


function theme_uowessential_set_themecolor($css, $themecolor) {
...
function theme_uowessential_set_themehovercolor($css, $themehovercolor) {
...
function theme_uowessential_set_footercolor($css, $footercolor) {
...
function theme_uowessential_set_footertextcolor($css, $footertextcolor) {
...
function theme_uowessential_set_footerurlcolor($css, $footerurlcolor) {
...
function theme_uowessential_set_footerhovercolor($css, $footerhovercolor) {
...
function theme_uowessential_set_footerheadingcolor($css, $footerheadingcolor) {
...
function theme_uowessential_set_footersepcolor($css, $footersepcolor) {
...
function theme_uowessential_set_navbarsep($css, $navbarsep) {
...
function theme_uowessential_set_pagebackground($css, $pagebackground, $setting) {
    global $OUTPUT;
...
function theme_uowessential_set_slideimage($css, $slideimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
...
function theme_uowessential_set_marketingheight($css, $marketingheight) {
...
function theme_uowessential_set_marketingimage($css, $marketingimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
...
function theme_uowessential_page_init(moodle_page $page) {
    $page->requires->jquery();
    $page->requires->jquery_plugin('cslider', 'theme_uowessential');
    $page->requires->jquery_plugin('custom', 'theme_uowessential'); 
    $page->requires->jquery_plugin('alerts', 'theme_uowessential');
    $page->requires->jquery_plugin('modernizr', 'theme_uowessential');  
}