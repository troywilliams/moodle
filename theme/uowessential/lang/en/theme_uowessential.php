...
/* Core */
$string['configtitle'] = 'uowessential';
$string['pluginname'] = 'uowessential';
$string['choosereadme'] = '
<div class="clearfix">
<div class="well">
<h2>uowessential</h2>
<p><img class=img-polaroid src="uowessential/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About uowessential</h3>
<p>uowessential is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
