...
$PAGE->requires->css('/mod/voicepodcaster/css/StyleSheet.css');
...
class mod_voicepodcaster_mod_form extends moodleform_mod {
    ...
    <div class="wimba_boxTop">
	    <div class="wimbaBoxTopDiv">
	            <span class="wimba_boxTopTitle"  style="width:300px;">'."Creation of a new Voice Podcaster :".'
	            </span>    
	            <span title="close" class="wimba_close_box" onclick="onCancelButtonPopup()">Close</span>     
	            <p style="text-align:left;"> 
	               <span style="padding-left:15px">Please enter a title for the new Voice Podcaster:</span>
	            </p>
	            <p>
