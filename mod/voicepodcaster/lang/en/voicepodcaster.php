...
$string['modulename_help'] = '<p>Wimba Voice Tools facilitate and promote vocal instruction, collaboration, coaching, and assessment -- perfect for language learning, and creating vocal exercises in any subject.</p><p>Four Voice Tools are available:</p><p>Voice Boards craft threaded voice discussions, public or private, lending a warm vocal component beyond traditional message boards.</p><p>Voice Presentations combine vocal and text-based commentary alongside a website or any other web-based content</p><p>Wimba Podcaster simplifies the popular medium of podcasting with an easy-to-use recording interface, automatic feed creation, and 1-click subscription.</p><p>Voice Recorder embeds an audio announcement, recorded by instructors, directly in a course (Note: this tool is only available within a separate Voice Recorder Block)</p>';
...
$string['configservername'] = 'Example: http://myschool.wimba.com/myschool';
...
//Choice Panel
$string['new_tool'] = 'New Wimba Voice Tool';
$string['new_board'] = 'New Board';
$string['new_presentation'] = 'New Presentation';  
$string['new_podcaster'] = 'New Wimba Podcaster';   
//Validation Bar
...
$string['VoiceBoardDescription'] = "Creates a new Wimba Voice Board";
$string['VoicePresentationDescription'] = "Creates a new Wimba Voice Presentation";
$string['PodcasterDescription'] = "Creates a new Wimba Podcaster";
...
$string["podcasterCreated"]="Your Wimba Podcaster has been successfully created.";
$string["podcasterUpdated"]="Your Wimba Podcaster has been successfully updated.";
$string["deletePodcaster"] = "Your Wimba Podcaster has been successfully deleted."; 
...
$string['launchstudent'] = "You are going to launch this Wimba Voice feature as a student. You will not have instructor privileges.";
...
$string["activity_welcome_to_wimba"]="Welcome to Voice Tools!";
...
$string['list_title_pc'] = "Wimba Podcaster";
...
$string['contextbar_new_voicetools'] = "New Wimba tools";
...
$string['general_pc'] = "Wimba Podcaster";
...
$string['error_license'] = "Access denied. You don't have a valid license to use the Voice Tools. Please speak with your System Administrator or contact Horizon Wimba (sales@horizonwimba.com) to inquire about subscribing to a license.";
...
$string['list_no_pcs'] = "There are no Wimba Podcaster available at this time";
