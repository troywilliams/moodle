...
$string['submittedfiles'] = 'Submitted Files';
$string['assignmentsubmissionreceipt'] = '<h3>Assignment Submission Receipt</h3><p>You have been emailed a copy of this receipt, please retain a copy as proof of your assignment submission.</p>';
$string['username'] = 'Username';
$string['receiptsubject'] = 'Assignment Receipt';
$string['assignment'] = 'Assignment';
$string['receipt'] = 'Receipt';
$string['validationfailed'] = '<h3>Validation Failed</h3><p>This file does not match the reciept number you entered.</p><p>Would you like to validate another file?</p>';
$string['validationsuccess'] = '<h3>Passed Validation</h3><p>This file correctly matches the reciept number.</p><p>Would you like to validate another file?</p>';
$string['invalidreceipt'] = 'Invalid receipt - check you have entered it correctly';
$string['verifyfile'] = 'Verify File';
$string['onceassignmentsent'] = '<p>I certify that this assignment is all my own work and does not include any copying or paraphrasing of another person&rsquo;s work. Where I have referred to another person&rsquo;s work I have referenced appropriately. I understand that this assignment may be submitted to a web-based plagiarism detection tool and give permission for the assignment to be used in that way. I certify that no part of this assignment has already been counted for assessment in this paper or any other paper.</p> <p>Once the assignment is sent for marking, you will no longer be able to delete or attach file(s). Do you want to continue?</p>';
