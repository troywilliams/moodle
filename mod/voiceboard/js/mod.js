...
function popupOk()
{
    $("popup").style.display="none";
    $("hiddenDiv").style.display="none";
    location.href = M.cfg.wwwroot+"/mod/voiceboard/index.php?id="+$F($('mform1')['course']);
}
...
function create(name,courseid){
    ...
    $("newPopup").hide();
    $('loading').show();
    createNewResource(M.cfg.wwwroot+"/mod/voiceboard/manageAction.php","voicetools","board",name.value,$F($('mform1')["url_params"]));
