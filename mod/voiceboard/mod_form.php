...
$PAGE->requires->css('/mod/voiceboard/css/StyleSheet.css');
...
class mod_voiceboard_mod_form extends moodleform_mod {
    ...
    <div class="wimba_boxTop">
	    <div class="wimbaBoxTopDiv">
	            <span class="wimba_boxTopTitle"  style="width:300px;">'."Creation of a new Voice Board :".'
	            </span>    
	            <span title="close" class="wimba_close_box" onclick="onCancelButtonPopup()">Close</span>     
	            <p style="text-align:left;"> 
	               <span style="padding-left:15px">Please enter a title for the new Voice Board:</span>
	            </p>
	            <p>
