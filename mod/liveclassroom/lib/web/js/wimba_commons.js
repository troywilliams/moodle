...
function displayItem(elementParameters) {
    ...
    if (item.length == 0) {
        display += "<tr>";
        display += "<td class=noPodcaster>The Wimba Podcaster for this course is empty. To make a recording, click the link below to open the Wimba Podcaster and create a new post.</td>";
        display += "</tr>";
    } else {
        if (item.length >= 5) {
            length = 5;
