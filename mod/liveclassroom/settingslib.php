 ...
 */
    ...
    public function output_html($data, $query='') {
        ...
        $return .= '</div>';
        $return .= '<div class="wimba_box" id="popup" style="width:350px;z-index:150;display:none;position:absolute;left: 38%; top: 25%;">
	 <div class="wimba_boxTop">
	    <div>
	            <span class="wimba_boxTopTitle"  style="width:300px;">Notice
	            </span>
	            <span title="close" class="wimba_close_box" onclick="lc_undisplayPopup();">Close</span>
	            <p>
	                   <span id="popupText" ></span>
	            </p>
	            <p style="height:20px;padding-top:10px;padding-left:20px">
	                <input class="regular_btn-submit" style="margin-left:70px;" type="button" id="advancedOk" onclick="lc_undisplayPopup()"  Value="Ok"/>
	            </p>
	    </div>
	</div>
...
</div><div id="hiddenDiv" class="opac" style="display:none">
