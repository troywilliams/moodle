...
$string['reviewfeedbackoptions'] = 'Review feedback options';
$string['selectmulti'] = 'Select one or more:';
$string['selectone'] = 'Select one:';
$string['showfeedbackallchoices'] = 'Show feedback for all choices';
$string['showfeedbackallchoices_help'] = 'Depends on setting review options: "Whether correct", "Specific feedback".<br><ul><li>Where "Whether correct" review option set, it will display correctness for all choice options.</li><li>Where "Specific feedback" review option set, it will display specific feedback for all choice options.</li></ul>';
